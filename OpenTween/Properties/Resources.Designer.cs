...
namespace OpenTween.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   AdventureTweenはリリースされていないため、アップデートも用意されていません。 に類似しているローカライズされた文字列を検索します。
        /// </summary>
        internal static string CheckNewVersionText99 {
            get {
                return ResourceManager.GetString("CheckNewVersionText99", resourceCulture);
            }
        }
